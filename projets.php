...
{
	$mres = mysql_query("SELECT DISTINCT `nom_proj` FROM `projects` WHERE `id_chef` = '$row[0]' ");
...
$drow = mysql_fetch_array($mres,MYSQL_NUM);
...
$id_user = $drow2[0];
	if($_POST['delete']))
		...
		$delete = mysql_real_escape_string(strtolower(trim($_POST['delete'])), $mysql);
